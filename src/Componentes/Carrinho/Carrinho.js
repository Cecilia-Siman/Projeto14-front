...
export default function Carrinho() {
    ...
    axios.get('https://project-myuniverse.herokuapp.com/carrinho', config)
        .then(res => {
    ...
    function DisplayItems(item) {
        ...
        return (
            <Item>
                ...
                <div>
                    <ion-icon name="close-circle" onClick={() => axios.delete('https://project-myuniverse.herokuapp.com/carrinho', { nome: item.nome })}></ion-icon>
